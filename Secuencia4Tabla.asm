...
SEVENSEG_LOOKUP 
	ADDWF PCL,f
	RETLW 0xA2 ;  //Hex value to display the number 0.
	RETLW 54h ;   //Hex value to display the number 1.
	RETLW 28h ;   //Hex value to display the number 2.
	RETLW 14h ;   //Hex value to display the number 3.
	RETLW 0X2A ;  //Hex value to display the number 4.
	RETLW 45h ;   //Hex value to display the number 5.
